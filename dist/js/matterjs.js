function initSimulation() {
  ...
  var tagFotografie = Bodies.rectangle(containerWidth / 2 + 150, 500, 164, 56, {
    ...
    render: {
      sprite: {
        texture: "../images/home/sponsor-maestro.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var tagVideo = Bodies.rectangle(containerWidth / 2 - 150, 460, 122, 56, {
    ...
    render: {
      sprite: {
        texture: "../images/home/sponsor-2.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var tagMerkstrategie = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-3.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagSocialcontent = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-4.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagWebstrategie = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-5.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagSocialstrategie = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-6.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagWebdesign = Bodies.rectangle(containerWidth / 2 - 142, 440, 167, 56, {
    ...
    render: {
      sprite: {
        texture: "../images/home/sponsor-7.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var tagWervingscampagne = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-8.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagCampagne = Bodies.rectangle(containerWidth / 2 - 242, 420, 174, 56, {
    ...
    render: {
      sprite: {
        texture: "../images/home/sponsor-9.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var tagTekstenvoorjongeren = Bodies.rectangle(
    ...
    56,
    {
      ...
      render: {
        sprite: {
          texture: "../images/home/sponsor-10.png",
          xScale: 1,
          yScale: 1,
        },
      },
  ...
  var tagBranddesign = Bodies.rectangle(containerWidth / 2, 360, 194, 56, {
    ...
    render: {
      sprite: {
        texture: "../images/home/sponsor-12.png",
        xScale: 1,
        yScale: 1,
      },
    },
